...
#+begin_export html
<style>
.lemma, .proof, .entailment, .definition, .note, .my_example, .characteristic, .assumption {
  border-radius: 10px;
  padding: 4px;
  border-style: groove;
  border-width: 3px;
...
\newenvironment{characteristic}
  {\begin{mdframed}[backgroundcolor=orange!5]}
  {\end{mdframed}}
\newenvironment{entailment}
  {\begin{mdframed}[backgroundcolor=green!10]entailment:\\}
  {\end{mdframed}}
\renewenvironment{proof}
  {\begin{mdframed}[backgroundcolor=green!10]proof:\\}
  {\end{mdframed}}
\newenvironment{lemma}
  {\begin{mdframed}[backgroundcolor=red!10]lemma:\\}
  {\end{mdframed}}
#+end_export
