...
#+HTML: <p style="height:0px; display: none;">\(\DeclareMathOperator{\dom}{domain}\)</p>
#+HTML: <p style="height:0px; display: none;">\(\DeclareMathOperator{\ran}{range}\)</p>
#+HTML: <p style="height:0px; display: none;">\(\DeclareMathOperator{\rng}{range}\)</p>
#+HTML: <p style="height:0px; display: none;">\(\DeclareMathOperator{\img}{Im}\)</p>
