...
theme.widget_time                               = theme.dir .. "/icons/time.png"
...
theme.widget_tux                                = theme.dir .. "/icons/tux.png"
theme.widget_arch                               = theme.dir .. "/icons/arch.png"
...
-- Tux
local tux = wibox.widget.imagebox(theme.widget_tux)
local arch = wibox.widget.imagebox(theme.widget_arch)
...
-- DATE
-- commented datetimeicon because the icon is black and the rest are white
-- local datetimeicon = wibox.widget.imagebox(theme.widget_time)
local datetime = awful.widget.watch({awful.util.shell, '-c', 'date "+%A %d/%m/%y %H:%M"'}, 0.5,
  function(widget, stdout)
...
-- was commented because it needs Gio/Glib >= 2.54
...
function theme.at_screen_connect(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            arrow("#8DAA9A", "#7a8055"),
            wibox.container.background(wibox.container.margin(wibox.widget { datetimeicon, datetime, layout = wibox.layout.align.horizontal }, dpi(3), dpi(3)), "#7a8055"),
            arrow("#7a8055", "alpha"),
